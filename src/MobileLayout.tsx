...
export function MobileLayout(props: ReturnType<typeof usePortalLogic>) {
  const {
    store, is24HourFormat, setIs24HourFormat, profilePic, fileInputRef,
    toggleDarkMode, handleProfilePicUpload, registeredCourses, completedCourses,
        ...
        <main className="flex-1 w-full p-4 md:p-8 relative isolate">
          <AnimatePresence mode="wait">
            ...
            >
              ...
              {/* === ACCOUNTS: STATEMENT === */}
              {activeTab === 'statement' && (
                 <div className="max-w-5xl"><StatementView /></div>
              )}
