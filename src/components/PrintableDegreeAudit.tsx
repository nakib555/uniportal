    ...
    <div className="hidden print:block font-serif text-black bg-white w-full max-w-[21cm] mx-auto absolute right-0 top-0 left-0 bottom-0 z-[100] min-h-screen p-8 print:static [print-color-adjust:exact] [-webkit-print-color-adjust:exact]">
       ...
       <div className="grid grid-cols-2 gap-4 mb-8 border border-black p-4">
           <div>
              ...
              <p><span className="font-bold">Student ID:</span> {student.id || "21104104"}</p>
           ...
           <table className="w-full text-left border-collapse border border-black">
              <thead>
                <tr className="bg-gray-100 border-b border-black print:bg-gray-100">
                   <th className="p-3 border-r border-black uppercase text-sm">Requirement Area</th>
                   <th className="p-3 border-r border-black uppercase text-sm text-center">Required (Cr)</th>
                   <th className="p-3 border-r border-black uppercase text-sm text-center">Completed</th>
                   <th className="p-3 border-r border-black uppercase text-sm text-center">Remaining</th>
                   <th className="p-3 uppercase text-sm text-center">Status</th>
                </tr>
              </thead>
              <tbody>
