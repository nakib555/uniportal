...
export function AccountsView({ portal }: { portal: ReturnType<typeof usePortalLogic> }) {
  ...
  const transactions = portal.studentData.transactions;
      ...
      <div className="space-y-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          <Card className="p-5 flex flex-col justify-center">
            ...
            <p className="text-3xl font-bold text-stone-900 dark:text-white">৳{currentBalance.toLocaleString()}</p>
          </Card>
          <Card className="p-5 flex flex-col justify-center">
          ...
          <div className="h-[300px] w-full">
            {transactions.length === 0 ? (
              <div className="h-full flex items-center justify-center text-stone-500 text-sm">
                No balance trends to display. Synchronize with the portal.
              </div>
            ) : (
                ...
                {transactions.length === 0 ? (
                  <tr>
                    <td colSpan={5} className="px-6 py-10 text-center text-stone-500">
                      No statement found. Synchronize with the portal to pull your academic statement.
                    </td>
                  </tr>
                ) : (
