  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
         <Card className="p-4 flex gap-4 items-center cursor-pointer hover:shadow-md transition-all group border-stone-200 dark:border-stone-800 hover:border-indigo-100 dark:hover:border-indigo-900/50 bg-white dark:bg-stone-950">
            ...
            <button className="px-3 py-1.5 border border-stone-200 dark:border-stone-700 text-stone-900 dark:text-stone-300 rounded-lg text-sm font-medium hover:bg-stone-100 dark:hover:bg-stone-800 transition-colors">Renew</button>
         </Card>
      </div>
