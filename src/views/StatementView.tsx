  ...
  return (
    <>
      ...
      {(portalSummary || portalInstalments) && (
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-8 pb-12 w-full max-w-5xl">
          {portalSummary && (
            <Card className="p-6 border-stone-200 dark:border-stone-800 bg-white dark:bg-stone-900 shadow-sm h-fit">
          ...
          <div className="flex flex-col gap-6">
            {portalInstalments && portalInstalments.length > 0 && (
              <Card className="p-6 border-stone-200 dark:border-stone-800 bg-white dark:bg-stone-900 shadow-sm flex flex-col justify-between h-fit">
                <div>
                  <h3 className="font-extrabold text-stone-900 dark:text-stone-100 text-sm mb-4 border-b border-stone-100 dark:border-stone-800 pb-3 flex items-center justify-between">
            ...
            {/* Attention Box */}
            <div className="bg-stone-50/50 dark:bg-stone-900/30 border border-stone-200 dark:border-stone-800 rounded-xl p-5">
              <div className="inline-block text-xs font-bold text-[#8c1515] dark:text-rose-400 bg-rose-100 dark:bg-rose-950/50 px-2.5 py-1 rounded mb-3 border border-rose-200 dark:border-rose-900/50">
                Attention!
              </div>
              <ol className="list-decimal list-inside text-xs text-stone-600 dark:text-stone-400 space-y-1.5 ml-1 leading-relaxed">
