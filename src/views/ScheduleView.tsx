  ...
  return (
    <div className="space-y-6">
      ...
      {groupedSchedule.length > 0 ? (
        <div className="flex overflow-x-auto pb-6 -mx-4 px-4 sm:mx-0 sm:px-0 scroll-smooth hide-scrollbar gap-6 items-start print:flex-wrap print:overflow-visible print:mx-0 print:px-0">
          {groupedSchedule.map(([day, classes]) => (
            <div key={day} className="flex-none w-[300px] md:w-[340px] flex flex-col print:w-full print:break-inside-avoid">
